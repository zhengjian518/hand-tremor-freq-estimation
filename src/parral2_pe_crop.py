...
if __name__ == '__main__':
    pe_instance = PARRAL2_PE_CROP()
    #video_path_list = ['/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Maanden_terug/kinect.avi',
     #                  '/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Pianospelen/kinect.avi',
      #                 '/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Rust/kinect.avi',
#		       '/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Spiraal_links/kinect.avi',
#	               '/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Spiraal_rechts/kinect.avi',
#		       '/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Rust_supinatie/kinect.avi',
#		       '/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Schrijven_links/kinect.avi',
#		       '/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Schrijven_rechts/kinect.avi',
 #                      '/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Top_neus_links/kinect.avi',
  #                     '/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Top_neus_rechts/kinect.avi',
   #                    '/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Top-top/kinect.avi',
    #                   '/media/tremor-data/TremorData_split/Tremor_data/T021_Links/Volgen/kinect.avi']
    
    video_task_list = util.get_full_path_under_folder('/media/tremor-data/TremorData_split/Tremor_data/T066_Links/')
    full_video_list=[]
    for task_path in video_task_list:
        task_path = task_path + 'kinect.avi'
        full_video_list.append(task_path)
#    full_video_list = ['/media/tremor-data/TremorData_split/Tremor_data/T041_Links/Top-top/kinect.avi',
#                       '/media/tremor-data/TremorData_split/Tremor_data/T041_Links/Volgen/kinect.avi']
