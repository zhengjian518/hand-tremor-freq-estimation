...
#	               '/media/tremor-data/TremorData_split/Tremor_data/T040_Links/Volgen/kinect.avi',]
    video_task_list = util.get_full_path_under_folder('/media/tremor-data/TremorData_split/Tremor_data/T065_Links/')
    full_video_list=[]
